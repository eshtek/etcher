const translation = {
	translation: {
		...
		completed: '完成',
		yesContinue: '是的，繼續',
		reallyExit: '真的要現在結束 HexOS Imager 嗎？',
		yesExit: '是的，可以結束',
		progress: {
			starting: '正在啟動……',
			decompressing: '正在解壓縮……',
		...
		message: {
			...
			exitWhileFlashing:
				'您目前正在刷寫。關閉 HexOS Imager 可能會導致您的磁碟無法使用。',
			...
			validation:
				'寫入已成功完成，但 HexOS Imager 在從磁碟讀取映像檔時檢測到潛在的損壞問題。\n\n請考慮將映像檔寫入其他磁碟。',
			openError: '打開 {{source}} 時發生錯誤。\n\n錯誤訊息： {{error}}',
			flashError: '燒錄 {{image}} {{targets}} 失敗。',
			unplug:
				'看起來 HexOS Imager 失去了對磁碟的連接。是不是被意外拔掉了？\n\n有時這個錯誤是因為讀卡器出了故障。',
			cannotWrite:
				'看起來 HexOS Imager 無法寫入磁碟的這個位置。此錯誤通常是由故障的磁碟、讀取器或連接埠引起的。\n\n請使用其他磁碟、讀卡器或連接埠重試。',
			childWriterDied:
				'寫入處理程序意外崩潰。請再試一次，如果問題仍然存在，請聯絡 HexOS Imager 團隊。',
		...
		drives: {
			...
			openInBrowser: 'HexOS Imager 會在瀏覽器中打開 {{link}}',
			changeTarget: '更改目標',
		...
		settings: {
			errorReporting: '匿名回報程式錯誤和使用統計資料',
			autoUpdate: '自動更新',
			settings: '軟體設定',
		...
		menu: {
			...
			window: '視窗',
			help: '協助',
			pro: 'HexOS Imager 專業版',
			website: 'HexOS Imager 的官網',
			issue: '提交 issue',
			about: '關於 HexOS Imager',
			hide: '隱藏 HexOS Imager',
			hideOthers: '隱藏其它視窗',
			unhide: '取消隱藏',
			quit: '結束 HexOS Imager',
		},
	},
};
