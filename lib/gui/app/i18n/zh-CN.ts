const translation = {
	translation: {
		...
		completed: '完毕',
		yesExit: '是的，可以退出',
		reallyExit: '真的要现在退出 HexOS Imager 吗？',
		yesContinue: '是的，继续',
		progress: {
			starting: '正在启动……',
			decompressing: '正在解压……',
		...
		message: {
			...
			exitWhileFlashing:
				'您当前正在刷机。 关闭 HexOS Imager 可能会导致您的磁盘无法使用。',
			...
			validation:
				'写入已成功完成，但 HexOS Imager 在从磁盘读取镜像时检测到潜在的损坏问题。 \n\n请考虑将镜像写入其他磁盘。',
			openError: '打开 {{source}} 时出错。\n\n错误信息： {{error}}',
			flashError: '烧录 {{image}} {{targets}} 失败。',
			unplug:
				'看起来 HexOS Imager 失去了对磁盘的连接。 它是不是被意外拔掉了？\n\n有时这个错误是因为读卡器出了故障。',
			cannotWrite:
				'看起来 HexOS Imager 无法写入磁盘的这个位置。 此错误通常是由故障的磁盘、读取器或端口引起的。 \n\n请使用其他磁盘、读卡器或端口重试。',
			childWriterDied:
				'写入进程意外崩溃。请再试一次，如果问题仍然存在，请联系 HexOS Imager 团队。',
		...
		menu: {
			...
			window: '窗口',
			help: '帮助',
			pro: 'HexOS Imager 专业版',
			website: 'HexOS Imager 的官网',
			issue: '提交一个 issue',
			about: '关于 HexOS Imager',
			hide: '隐藏 HexOS Imager',
			hideOthers: '隐藏其它窗口',
			unhide: '取消隐藏',
			quit: '退出 HexOS Imager',
		},
		source: {
		...
		drives: {
			...
			openInBrowser: 'HexOS Imager 会在浏览器中打开 {{link}}',
			changeTarget: '改变目标',
